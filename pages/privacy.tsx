...
export default function privacy() {
	return (
		<div className="dark:text-white p-5 md:p-10 h-full flex-1">
			...
			<h2 className="py-3 font-semibold text-xl">Interpretation</h2>
			<p>
			...
			<h2 className="py-3 font-semibold text-xl">Definitions</h2>
			...
			<ul className="list-disc pl-5">
				...
				<li>
					<p>
						...
						this Agreement) refers to Grade Melon.
					</p>
				</li>
				<li>
					<p>
			...
			<h1 className="pt-5 font-bold text-3xl">Collecting and Using Your Personal Data</h1>
			<h2 className="py-3 font-semibold text-xl">Types of Data Collected</h2>
			<h3 className="pb-3 font-semibold text-lg">Personal Data</h3>
			<p>
			...
			<h3 className="py-3 font-semibold text-lg">Usage Data</h3>
			...
			<h3 className="py-3 font-semibold text-lg">Tracking Technologies and Cookies</h3>
			<p>
			...
			<h2 className="py-3 font-semibold text-xl">Use of Your Personal Data</h2>
			...
			<h2 className="py-3 font-semibold text-xl">Retention of Your Personal Data</h2>
			<p>
			...
			<h2 className="py-3 font-semibold text-xl">Transfer of Your Personal Data</h2>
			<p>
			...
			<h2 className="py-3 font-semibold text-xl">Delete Your Personal Data</h2>
			<p>
			...
			<h2 className="py-3 font-semibold text-xl">Disclosure of Your Personal Data</h2>
			<h3 className="py-3 font-semibold text-lg">Business Transactions</h3>
			<p>
			...
			<h3 className="py-3 font-semibold text-lg">Law enforcement</h3>
			<p>
				Under certain circumstances, the Company may be required to disclose
				Your Personal Data if required to do so by law or in response to valid
				requests by public authorities (e.g. a court or a government agency).
			</p>
			<h3 className="py-3 font-semibold text-lg">Other legal requirements</h3>
			<p>
			...
			<h2 className="py-3 font-semibold text-xl">Security of Your Personal Data</h2>
			<p>
			...
			<h1 className="pt-5 font-bold text-3xl">Children&apos;s Privacy</h1>
			<p>
			...
			<h1 className="pt-5 font-bold text-3xl">Links to Other Websites</h1>
			<p>
			...
			<h1 className="pt-5 font-bold text-3xl">Changes to this Privacy Policy</h1>
			<p>
